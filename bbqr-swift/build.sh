#!/bin/bash
# This script builds local bbqr Swift language bindings and corresponding bbqrFFI.xcframework.
...
mkdir -p bbqrFFI.xcframework/ios-arm64/bbqrFFI.framework/Headers
mkdir -p bbqrFFI.xcframework/ios-arm64_x86_64-simulator/bbqrFFI.framework/Headers
mkdir -p bbqrFFI.xcframework/macos-arm64_x86_64/bbqrFFI.framework/Headers
...
cp Sources/Bbqr/bbqrffiFFI.h bbqrFFI.xcframework/ios-arm64/bbqrFFI.framework/Headers
cp Sources/Bbqr/bbqrffiFFI.h bbqrFFI.xcframework/ios-arm64_x86_64-simulator/bbqrFFI.framework/Headers
cp Sources/Bbqr/bbqrffiFFI.h bbqrFFI.xcframework/macos-arm64_x86_64/bbqrFFI.framework/Headers
cp ../bbqr-ffi/target/aarch64-apple-ios/release-smaller/libbbqrffi.a bbqrFFI.xcframework/ios-arm64/bbqrFFI.framework/bbqrFFI
cp ../bbqr-ffi/target/lipo-ios-sim/release-smaller/libbbqrffi.a bbqrFFI.xcframework/ios-arm64_x86_64-simulator/bbqrFFI.framework/bbqrFFI
cp ../bbqr-ffi/target/lipo-macos/release-smaller/libbbqrffi.a bbqrFFI.xcframework/macos-arm64_x86_64/bbqrFFI.framework/bbqrFFI
